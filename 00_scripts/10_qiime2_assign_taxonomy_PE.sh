...
export TMPDIR='/Users/pierre-louisstenger/Documents/PostDoc_02_MetaBarcoding_IAC/02_Data/07_01_Rhabdastrella_globostellata_and_Dysidea_microbiome/Rhabdastrella_globostellata_and_Dysidea_microbiome'
echo $TMPDIR
